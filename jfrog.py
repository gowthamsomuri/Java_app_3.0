...
def jfrogUpload() :
    ...
    url = 'http://18.234.100.236:8082/artifactory/example-repo-local/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    file_path = '/var/lib/jenkins/workspace/cicd/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    username = 'admin'
